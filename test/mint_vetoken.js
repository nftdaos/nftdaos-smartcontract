...
contract("Mint", function (accounts) {
  ...
  it("mint vault sucessful", async function () {
    ...
    await vaultFactory.mint('XXX', 'XXX', testERC721.address, '1', web3.utils.toWei('1000000', 'ether'), web3.utils.toWei('100000', 'ether'), web3.utils.toWei('0.1', 'ether'), 20000)
    ...
    console.log(bnftId.toString(), bnftURI)

    await tokenVaultStaking.redeemFToken(web3.utils.toWei('200000', 'ether'));

    await tokenVaultStaking.convertFTokenToVeToken(web3.utils.toWei('200000', 'ether'));

    await tokenVault.start(web3.utils.toWei('0.1', 'ether'), { from: accounts[5], value: web3.utils.toWei('0.1', 'ether') })
