...
contract("Fraction", function (accounts) {
  it("should assert true", async function () {
    ...
    await weth.approve(tokenVault.address, web3.utils.toWei('1', 'ether'), {from: accounts[1]})
    await tokenVault.start(web3.utils.toWei('0.01', 'ether'), web3.utils.toWei('0.01', 'ether'), {from: accounts[1]});
